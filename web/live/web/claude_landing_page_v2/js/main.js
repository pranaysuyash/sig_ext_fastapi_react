...
function initDemoCarousel() {
    ...
    function showStep(stepNumber) {
        ...
        const currentStepEl = document.querySelector(`.demo-step[data-step="${stepNumber}"]`);
        const currentDotEl = document.querySelector(`.demo-dot[data-step="${stepNumber}"]`);
        ...
        if (button) {
            button.addEventListener('click', (e) => {
                ...
                if (button.id === 'demoBtn') {
                    ...
                    alert('Thank you for your interest! Purchase flow would be integrated here.');
                }
...
// Console Art
// ============================================
console.log('%cSignature Extractor', 'font-size: 24px; font-weight: bold; color: #3b82f6;');
console.log('%cBuilt with care for professionals who need precision and privacy.', 'font-size: 12px; color: #6b7280;');
console.log('%cInterested in how this was built? Check out the code!', 'font-size: 12px; color: #10b981;');
