...
Creates a proper .app bundle with all dependencies.
"""
...
exe = EXE(
    ...
    argv_emulation=True,  # Important for macOS drag-and-drop
    target_arch='arm64',  # Build for ARM64 only (Apple Silicon)
    codesign_identity=None,
    entitlements_file=None,
)

# COLLECT for macOS bundle
coll = COLLECT(
    exe,
    a.binaries,
    a.zipfiles,
