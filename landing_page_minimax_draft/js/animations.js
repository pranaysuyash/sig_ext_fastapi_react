...
class AnimationManager {
    ...
    initHoverAnimations() {
        ...
        const magneticElements = document.querySelectorAll('.btn, .feature-card, .use-case-card');
        ...
        // Glow effects
        const glowElements = document.querySelectorAll('.pricing-card, .hero-cta .btn');
        ...
        // Tilt effect
        const tiltElements = document.querySelectorAll('.feature-card, .use-case-card, .testimonial-card');
    ...
    revealEffect(element, direction) {
        ...
        if (direction === 'rotate') element.style.transform = 'rotate(10deg) scale(0.8)';
