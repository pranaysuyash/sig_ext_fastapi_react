...
By downloading, installing, or using Signature Extractor ("the Application"), you agree to be bound by these Terms of Service ("Terms") and our Privacy Policy. If you do not agree to these Terms, do not use the Application.
...
- **Use** Signature Extractor on devices you own or control
- **Process** your own images and documents
- **Create** and use extracted signatures for legitimate purposes
...
- ❌ **Reverse engineer** the Application or attempt to extract source code
- ❌ **Distribute** the Application to third parties
- ❌ **Create derivative works** based on the Application
- ❌ **Remove or alter** copyright notices or license information
- ❌ **Use for illegal purposes** or in violation of applicable laws
- ❌ **Circumvent license restrictions** through technical means
- ❌ **Use on more devices** than reasonably necessary for personal use
...
You may use Signature Extractor to:

- ✅ **Extract signatures** from documents you own or have rights to
- ✅ **Process images** for personal or professional use
- ✅ **Create digital signatures** for legitimate business purposes
- ✅ **Prepare documents** for digital signing workflows
- ✅ **Archive signatures** from paper documents

### 4.2 Prohibited Uses

You may NOT use Signature Extractor to:

- ❌ **Forge signatures** or create fraudulent documents
- ❌ **Violate copyright** or intellectual property rights
- ❌ **Process illegal content** or contraband
- ❌ **Harass, defame, or harm** others
- ❌ **Violate privacy rights** of individuals
- ❌ **Circumvent security measures** on protected documents
- ❌ **Use for high-risk applications** (medical, legal without verification)
...
- **Accuracy** of extracted signatures

## 5. Intellectual Property

### 5.1 Application Rights

All rights to Signature Extractor are owned by us or our licensors:

- **Source Code**: Proprietary and protected by copyright
- **Trademarks**: "Signature Extractor" and related marks
- **Documentation**: Protected by copyright and other laws
- **User Interface**: Protected by design rights
...
- **Provide updates** for critical bugs and security issues

### 6.2 Disclaimer of Warranty

**EXCEPT AS EXPRESSLY PROVIDED**, we make NO warranties:

- **NO WARRANTY** that the Application will meet your specific needs
- **NO WARRANTY** that the Application will be error-free or uninterrupted
- **NO WARRANTY** regarding the accuracy of signature extraction
- **NO WARRANTY** for fitness for a particular purpose
...
- **Liability**: You assume all liability for professional use
...
- **Direct Damages**: Up to the amount you paid for the Application
- **No Consequential Damages**: No liability for lost profits, data, or business
- **No Indirect Damages**: No liability for indirect, special, or punitive damages
...
- **Local Processing**: All signature extraction happens on your device
- **No Data Collection**: We don't collect your documents or images
- **Secure Design**: Built with privacy as a core principle
- **Transparency**: Clear about what data we process and why
...
**These Terms continue** until terminated by you or us.
...
- **Not install** updates without your consent
...
- **Alternatives**: Recommendations for alternatives
...
No waiver of any provision unless in writing and signed by us.
...
These Terms constitute the entire agreement between us regarding the Application.
...
You acknowledge and agree to comply with all applicable export laws and regulations.
...
Continued use of the Application after modifications constitutes acceptance of the revised Terms.
